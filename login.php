...
<div id="main-wrapper">
  <div class="unix-login">
    ...
    <div class="container-fluid" style="background-image: url('assets/uploadImage/Logo/pig-blue-background_1920x1080.jpg');
 background-color: #ffffff;background-size:100%,100%">
      <div class="row ">
        <div class="col-md-4">
          <div class="login-content ">
            <div class="login-form">
              <center><img src="./assets/uploadImage/Logo/P.gif" style="width: 200px; border-radius:20px"></center><br>
