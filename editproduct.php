...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Editar Cerdo</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                <li class="breadcrumb-item active">Editar Cerdo</li>
            </ol>
        </div>
    </div>
                            ...
                            <form action="php_action/editProductImage.php?id=<?php echo $_GET['id']; ?>" method="POST" id="updateProductImageForm" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label class="col-sm-3 control-label">Imagen ID</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <div class="kv-avatar center-block">
                                                    <input type="file" class="form-control" id="productImage" placeholder="Observación" name="productImage" class="file-loading" style="width:auto;" />
                                                </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="expdate" placeholder="Fecha de Nacimiento" name="expdate" value="<?php echo $result['expdate'] ?>" autocomplete="off" required="" pattern="^[0-9]+$" />
                                        </div>
                                        <div class="form-group col-md-6">
