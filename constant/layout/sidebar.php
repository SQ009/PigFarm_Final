         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
                     <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-pencil "></i><span class="hide-menu">Razas</span></a>
                         <ul aria-expanded="false" class="collapse">

                             <li><a href="add-brand.php">Agregar Razas</a></li>

                             <li><a href="brand.php">Gestionar Razas</a></li>
                         </ul>
                     </li>
                 <?php } ?>
                 <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
                     <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-medkit"></i><span class="hide-menu">Medicinas</span></a>
                         <ul aria-expanded="false" class="collapse">

                             <li><a href="add-category.php">Agregar Medicinas</a></li>

                             <li><a href="categories.php">Gestionar Medicinas</a></li>
                         </ul>
                     </li>
                 <?php } ?>
                 <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
                     <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-list"></i><span class="hide-menu">Cerdo</span></a>
                         <ul aria-expanded="false" class="collapse">

                             <li><a href="add-product.php">Agregar Cerdo</a></li>

                             <li><a href="product.php">Gestionar Cerdos</a></li>
                         </ul>
                     </li>
                 <?php } ?>
