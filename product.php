...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary"> Gestionar Cerdos</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                <li class="breadcrumb-item active">Gestionar Cerdos</li>
            </ol>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="add-product.php"><button class="btn btn-primary">Agregar Cerdos</button></a>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th style="width:10%;">FotoID</th>

                                <th>Observaciones</th>
                                <th>Precio de cerdo</th>
                                <th>Peso</th>
                                <th>Raza</th>
                                <th>Medicina sumistrada</th>
                                <th>Estado</th>
                                <th>Acción</th>
                            </tr>
                        </thead>
