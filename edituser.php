                            ...
                            <form class="form-horizontal" method="POST" id="submitUserForm" action="php_action/editUser.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="edituserName" id="edituserName" class="form-control" placeholder="Usuario" required="" pattern="^[a-zA-z0-9]+$" / value="<?php echo $result['username'] ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" name="create" id="editProductBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">Enviar</button>
                            </form>
                        </div>
                    </div>
                </div>
